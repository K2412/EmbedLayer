...
final class PostgresConnector implements DataSourceConnector
{
    ...
    {
        $rows = $this->makeConnection()->select(<<<'SQL'
    ...
    {
        return $this->connections->makeForDriver($this->dataSource, 'pgsql', [
            'sslmode' => 'prefer',
            'charset' => 'utf8',
            'schema' => 'public',
            'prefix' => '',
